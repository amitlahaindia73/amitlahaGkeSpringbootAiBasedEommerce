package com.amitra.commercemesh.order.exception;

import com.amitra.commercemesh.order.api.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ConflictException.class, InvalidOrderException.class})
