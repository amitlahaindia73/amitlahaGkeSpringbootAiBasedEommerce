package com.amitra.commercemesh.user.config;
...
public class ApplicationLoggingAspect {
    ...
    @Around("within(com.amitra.commercemesh.user..controller..*) || within(com.amitra.commercemesh.user..service..*) || within(com.amitra.commercemesh.user..filter..*)")
